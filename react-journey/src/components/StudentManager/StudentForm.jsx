...
function StudentForm({ studentName,usernameRef, studentAge, studentCourse, isEditing, handleSubmit, setStudentName, setStudentAge, setStudentCourse, error }) {
    return (
        <div className="form-card">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input   ref={usernameRef} type="text" id="name" name="name" value={studentName} onChange={(e) => setStudentName(e.target.value)} />
